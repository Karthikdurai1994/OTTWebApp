...
@Component({
  ...
  templateUrl: "./subscriber-login.page.html",
  styleUrls: ["./subscriber-login.page.scss"],
})
export class SubscriberLoginPage implements OnInit {
  isLogin = true;
  constructor(
  ...
  onSubmit(form: NgForm) {
    ...
    //  this.router.navigateByUrl("welcome/subscriberLogin/subscribermovie")
    if (this.isLogin) {
